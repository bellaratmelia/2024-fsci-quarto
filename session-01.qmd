...
-   Quarto supports R, Python,
-   use Quarto within Jupyter Notebook
...
```         
For example, the markdown source for the first bullet point on this slide is 
`` \ ` * ``
```
:::
...
-   everything inside the 'fences' is treated literally as code or plain text, and not processed by Markdown
