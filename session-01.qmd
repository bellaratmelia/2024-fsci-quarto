...
*What is your research area? Are you familiar with RStudio or R Markdown?*
...
5.  Install these R packages by copying this line to your Terminal: `install.packages(c( "tidyverse", "gt", "rmarkdown", "gtsummary"))`
=======
4.  Clone the GitHub repository from `https://github.com/bellaratmelia/2024-fsci-quarto-handouts.git` - Refer to [instructions](https://bellaratmelia.github.io/2024-fsci-quarto/#pre-session-preparation)
5.  Install these R packages:
...
```
>>>>>>> ab793c41f298b74c3b96c75fbf347d95cb4af62c
...
Follow instructions for `Hands-on #3` at file path: `01-quarto-basics/YAML.qmd`
...
This is the code for a *pipe table*:
...
Try out figures, tables and cross references.
