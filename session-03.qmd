...
Refer to `session-03/publishing-to-quartopub.qmd` for the step-by-step guide for this activity.
...
Refer to `session-03/publishing-to-gh-pages.qmd` for the step-by-step guide for this activity.
