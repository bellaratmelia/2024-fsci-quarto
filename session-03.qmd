...
::: columns
::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-masiello-group.png)
[Masiello Research Group](https://faculty.washington.edu/masiello/) from University of Washington
:::

::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-practical-deep-learning.png)
[Practical Deep Learning (online course)](https://course.fast.ai/) from fast.ai
:::

::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-nasa-openscapes.png)
[NASA & OpenScapes website](https://nasa-openscapes.github.io/)
:::
...
::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-mike-mahoney.png)
[Mike Mahoney](https://www.mm218.dev/) personal website & blog
:::

::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-mockup.png)
[Tom Mock](https://themockup.blog/) personal website & blog
:::
...
::: columns
::: {.column width="33%"}
![](https://quarto.org/docs/gallery/books/books-r4ds.png)
[R for Data Science (2nd edition)](https://r4ds.hadley.nz/) by Hadley Wickham and Mine Çetinkaya-Rundel, and Garrett Grolemund
:::

::: {.column width="33%"}
![](https://quarto.org/docs/gallery/books/books-python-for-data.png)
[Python for Data Analysis (3rd edition)](https://wesmckinney.com/book/) by Wes McKinney
:::

::: {.column width="33%"}
![](https://quarto.org/docs/gallery/websites/websites-hopr.png)
[Hands-on Programming with R](https://jjallaire.github.io/hopr/) by Garret Grolemund
:::
